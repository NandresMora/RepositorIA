...
const SearchFilter = ({
  ...
  return (
    <section className="bg-surface-container-low p-8 rounded-2xl border border-outline-variant/30 mb-8 max-w-7xl mx-auto shadow-sm" aria-label="Filtros técnicos">
      <div className="flex flex-col gap-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="flex flex-col gap-4">
            <header className="flex items-center gap-2 text-on-surface-variant/70">
              ...
              <h3 className="text-[9px] font-bold uppercase tracking-[0.2em] font-geist">Pilares de Ingeniería</h3>
            </header>
          ...
          >
            <header className="flex items-center gap-2 text-on-surface-variant/70">
              ...
              <h3 className="text-[9px] font-bold uppercase tracking-[0.2em] font-geist">Categorías Técnicas</h3>
            </header>
            ...
            <div className={`flex items-center justify-between px-5 py-3.5 bg-surface-container-lowest border rounded-xl cursor-default transition-all ${
              ...
              <div className="flex items-center gap-3">
                <span className="text-[10px] font-bold uppercase tracking-widest font-geist text-on-surface">
                  {selectedCategory === 'All' ? 'Seleccionar Unidad Técnica' : selectedCategory}
                </span>
              ...
              {isHoveringCategories && (
                ...
                >
                  {categories.map((category) => (
                    ...
                    >
                      {category === 'All' ? 'Todas' : category === 'Other' ? 'Otras' : category}
                    </button>
                  ))}
                </motion.div>
              )}
        ...
        <div className="relative pt-8 border-t border-outline-variant/20">
          <header className="flex items-center gap-2 text-on-surface-variant/70 mb-4">
            ...
            <h3 className="text-[9px] font-bold uppercase tracking-[0.2em] font-geist">Descubrimiento Global</h3>
          </header>
          <div className="relative group">
            ...
            <input
              type="text"
              placeholder="Buscar activos por nombre, propósito o caso de implementación..."
              value={searchQuery}
